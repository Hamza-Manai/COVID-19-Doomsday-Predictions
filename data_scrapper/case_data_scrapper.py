...
class CasesDataScrapper(DataScrapper):
    PREFIX = "case"
    ...
    def scrap_data(self):
        ...
        data = graphs_scrapper.get_data("coronavirus-cases", case_type = 0)
        filename = self.get_dataset_file_name()

        self.save_data_to_file(filename, data)

    def get_dataset_file_name(self, dataset_date=""):
        return super().get_dataset_file_name(CasesDataScrapper.PREFIX, dataset_date=dataset_date)
